...
import { AuthLibrary, createExpressAuth } from '@auth-library/core';
...
import { AuthLibrary, createWebSocketAuth } from '@auth-library/core';
...
```typescript
import { AuthLibrary, User, Permission, Role } from '@auth-library/core';
